        ...
        while True:
            ...
            if (player==2 and dealer==2):
                ...
                if (play==False):
                    ...
                    return self.visible
                    #break 
                #print('player_hand=',self.hand)
                if (int(self.hand)<21):
                    while playing:  # recall this variable from our hit_or_stand function
                        
                        # Prompt for Player to Hit or Stand
                        hit_or_stand(deck, player_hand,self.hold)
                ...
                if player_hand.value <= 21:
                    ...
                    self.hand_player= player_hand
                    self.hand_dealer= dealer_hand
                # Ask to play again
                if (self.hold != 'p'):
